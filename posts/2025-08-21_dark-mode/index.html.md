...
::: {#9278caaa .cell renderings='["light","dark"]' execution_count=1}
...
::: {.cell-output .cell-output-display}
![](index_files/figure-html/cell-2-output-2.png){width=665 height=431}
:::
:::
...
::: {#147ec406 .cell renderings='["light","dark"]' execution_count=2}
...
::: {.cell-output .cell-output-display}
![](index_files/figure-html/cell-3-output-2.png){width=665 height=431}
:::
:::
